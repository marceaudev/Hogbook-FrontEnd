...
async function onSubmit() {
  ...
  try {
    ...
    const msg =
      ...
      (e?.message?.includes('Network') ? 'Serveur injoignable.' : 'Une erreur est survenue.')
...
<template>
  <main class="container">
    ...
    <form class="loginForm" @submit.prevent="onSubmit">
      <div class="name">
        <input v-model="firstname" type="text" required placeholder="Prénom" />
        <input v-model="lastname" type="text" required placeholder="Nom" />
      </div>
      <input v-model="username" type="text" required placeholder="Nom d'utilisateur" />
